...
public class JsonParser {
    ...
    public static final int TEXT_ITEM_SIZE = 100;
    ...
    private ColumnMetadataDto toColumnMetadata(String body) throws ConnException {
        ...
        int precision = 0;
        if (type.size() > 3) {
            precision = type.get(3).asInt();
        }

        return new ColumnMetadataDto(truVarchar, name, nullable, valueType, valueSize, scale, precision);
    }
